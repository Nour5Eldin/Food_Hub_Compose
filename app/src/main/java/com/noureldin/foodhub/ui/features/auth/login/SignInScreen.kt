...
fun SignInScreen(navController: NavController,viewModel: SignInViewModel = hiltViewModel()) {
    Box(modifier = Modifier.fillMaxSize()){
        ...
        Column (modifier = Modifier
            ...
            Button(onClick = { viewModel.onSignInClick() }, modifier = Modifier.height(60.dp), colors = ButtonDefaults.buttonColors(containerColor = orange)) {
                Box {
            ...
            val fullText = stringResource(id = R.string.do_not_have_account) // "Already have an account? Login"
            val loginText = "Signup"
